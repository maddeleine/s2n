...
"""
This test file ensures that a serialized connection can be deserialized by an older version of
s2n-tls and vice versa. This ensures that any change we make to the handshake is backwards-compatible
...
This prevents one a peer from receiving a TCP FIN message and shutting the connection down early.
"""
